...
<div class="flex flex-col gap-8 md:grid md:grid-cols-[1fr_4fr] md:gap-8">
    ...
    <section class="prose mx-8 my-8 flex flex-col gap-16 md:max-w-200">
        ...
        <section id="solution">
            ...
            <div>
                <img class="border border-border w-full" src={hardwarerender} alt="hardware prototype" />
                <p class="text-[0.9em] text-text-secondary mt-2">Render of the Memory Mend retrofit device next to a sewing machine.</p>
            </div>
            <div>
                <img class="border border-border w-full" src={hardwareprototype} alt="hardware prototype" />
                <p class="text-[0.9em] text-text-secondary mt-2">Final working prototype of the Memory Mend retrofit device.</p>
            </div>
            <h4>Software</h4>
        ...
        <section id="process">
            ...
            <img class="border border-border w-full" style="border:none;" src={uisketch} alt="ui sketch" />
            <p class="text-[0.9em] text-text-secondary mt-2">Early sketches exploring various flows within the app.</p>
            ...
            <img class="border border-border w-full" src={patterngeneration} alt="pattern generation" />
            <p class="text-[0.9em] text-text-secondary mt-2">Diagram of memory encoding and decoding process.</p>
            ...
            <div class="grid grid-cols-1 gap-4 my-4 md:grid-cols-2">
                <img class="border border-border w-full" src={component0} alt="hardware component 1" />
                <img class="border border-border w-full" src={component1} alt="hardware component 1" />
                <img class="border border-border w-full" src={component2} alt="hardware component 2" />
                <img class="border border-border w-full" src={component3} alt="hardware component 3" />
            </div>
